use crate::utils::write_image_to_file;
...
pub fn generate_planet(seed: u32) {
    ...
    let CONTINENT_FREQUENCY: f64 = rng.gen_range(0.0..2.0);

    // Lacunarity of the planet's continents. Changing this value produces
    // slightly different continents. For the best results, this value should
    // be random, but close to 2.0.
    let CONTINENT_LACUNARITY: f64 = rng.gen_range(1.8..2.2);

    // Lacunarity of the planet's mountains. Changing the value produces
    // slightly different mountains. For the best results, this value should
    // be random, but close to 2.0.
    let MOUNTAIN_LACUNARITY: f64 = rng.gen_range(1.8..2.2);
    ...
    let HILLS_LACUNARITY: f64 = rng.gen_range(1.8..2.2);
    ...
    // random, but close to 2.0.
    let PLAINS_LACUNARITY: f64 = rng.gen_range(1.8..2.2);

    // Lacunarity of the planet's badlands. Changing this value produces
    // slightly different badlands. For the best results, this value should
    // be random, but close to 2.0.
    let BADLANDS_LACUNARITY: f64 = rng.gen_range(1.8..2.2);

    // Specifies the "twistiness" of the mountains.
    let MOUNTAINS_TWIST: f64 = rng.gen_range(0.0..2.0);

    // Specifies the "twistiness" of the hills.
    let HILLS_TWIST: f64 = rng.gen_range(0.0..2.0);

    // Specifies the "twistiness" of the badlands.
    let BADLANDS_TWIST: f64 = rng.gen_range(0.0..2.0);

    // Specifies the planet's sea level. This value must be between -1.0
    // (minimum planet elevation) and +1.0 (maximum planet elevation).
    let SEA_LEVEL: f64 = rng.gen_range(-0.9..0.9);

    // Specifies the level on the planet in which continental shelves appear.
    // This value must be between -1.0 (minimum planet elevation) and +1.0
    // (maximum planet elevation), and must be less than `SEA_LEVEL`.
    let SHELF_LEVEL: f64 = rng.gen_range(-1.0..SEA_LEVEL);
    ...
    let MOUNTAINS_AMOUNT: f64 = rng.gen_range(0.0..1.);
    ...
    let HILLS_AMOUNT: f64 = (1.0 + MOUNTAINS_AMOUNT) / 2.0;

    // Determines the amount of badlands terrain that covers the planet.
    // Values range from 0.0 (no badlands) to 1.0 (all terrain is covered in
    // badlands). Badlands terrain will overlap any other type of terrain.
    let BADLANDS_AMOUNT: f64 = rng.gen_range(0.0..1.0);
    ...
    let TERRAIN_OFFSET: f64 = rng.gen_range(0.0..3.0);

    // Specifies the amount of "glaciation" on the mountains. This value
    // should be close to 1.0 and greater than 1.0.
    let MOUNTAIN_GLACIATION: f64 = rng.gen_range(1.0..1.5);

    // Scaling to apply to the base continent elevations, in planetary
    // elevation units.
    let CONTINENT_HEIGHT_SCALE: f64 = (1.0 - SEA_LEVEL) / 4.0;

    // Maximum depth of the rivers, in planetary elevation units.
    let RIVER_DEPTH: f64 = rng.gen_range(0.0..0.4);
    ...
    fn baseContinentDef(
        ...
        let baseContinentDef_fb0 = Fbm::<Perlin>::new(seed)
            .set_frequency(con_freq)
            .set_persistence(0.5)
            .set_lacunarity(con_lac)
            .set_octaves(14);
        ...
        let baseContinentDef_fb1 = Fbm::<Perlin>::new(seed + 1)
            .set_frequency(con_freq * 4.34375)
            .set_persistence(0.5)
            .set_lacunarity(con_lac)
            .set_octaves(11);
    ...
    let continentDef_se = Select::new(
        baseContinentDef(seed, CONTINENT_FREQUENCY, CONTINENT_LACUNARITY, SEA_LEVEL),
        continentDef_tu2,
        baseContinentDef(seed, CONTINENT_FREQUENCY, CONTINENT_LACUNARITY, SEA_LEVEL),
    )
    ...
    let mountainBaseDef_rm0 = RidgedMulti::<Perlin>::new(seed + 30)
    ...
    // next step.
    let mountainBaseDef_rm1 = RidgedMulti::<Perlin>::new(seed + 31)
        .set_frequency(367.0)
        .set_lacunarity(MOUNTAIN_LACUNARITY)
        .set_octaves(1);
    ...
    // mountains.
    let mountainousHigh_rm0 = RidgedMulti::<Perlin>::new(seed + 40)
    ...
    // mountains.
    let mountainousHigh_rm1 = RidgedMulti::<Perlin>::new(seed + 41)
    ...
    // terrain.
    let mountainousLow_rm0 = RidgedMulti::<Perlin>::new(seed + 50)
    ...
    // terrain.
    let mountainousLow_rm1 = RidgedMulti::<Perlin>::new(seed + 51)
    ...
    let hillyTerrain_bi = Billow::<Perlin>::new(seed + 60)
    ...
    let hillyTerrain_rm = RidgedMulti::<Perlin>::new(seed + 61)
        .set_frequency(367.5)
        .set_lacunarity(HILLS_LACUNARITY)
        .set_octaves(1);
    ...
    let plainsTerrain_bi0 = Billow::<Perlin>::new(seed + 70)
    ...
    let plainsTerrain_bi1 = Billow::<Perlin>::new(seed + 71)
        .set_frequency(1097.5)
        .set_persistence(0.5)
        .set_lacunarity(PLAINS_LACUNARITY)
        .set_octaves(8);
    ...
    let badlandsSand_rm = RidgedMulti::<Perlin>::new(seed + 80)
    ...
    let badlandsSand_wo = Worley::new(seed + 81)
    ...
    let badlandsCliffs_fb = Fbm::<Perlin>::new(seed + 90)
    ...
    let scaledMountainousTerrain_fb = Fbm::<Perlin>::new(seed + 110)
        .set_frequency(14.5)
        .set_persistence(0.5)
        .set_lacunarity(MOUNTAIN_LACUNARITY)
        .set_octaves(6);
    ...
    let scaledHillyTerrain_fb = Fbm::<Perlin>::new(seed + 120)
        .set_frequency(13.5)
        .set_persistence(0.5)
        .set_lacunarity(HILLS_LACUNARITY)
        .set_octaves(6);
    ...
    let continentalShelf_rm = RidgedMulti::<Perlin>::new(seed + 130)
    ...
    let continentsWithBadlands_bm = Fbm::<Perlin>::new(seed + 140)
        .set_frequency(16.5)
        .set_persistence(0.5)
        .set_lacunarity(CONTINENT_LACUNARITY)
        .set_octaves(2);
